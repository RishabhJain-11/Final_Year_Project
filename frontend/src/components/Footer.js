        ...
        <footer className="bg-white">
            <div className="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-24">
                <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                    <div>
                        <div className="flex items-center justify-center sm:justify-start gap-2 bg-gradient-to-r from-indigo-800 via-violet-600 to-fuchsia-400 bg-clip-text text-transparent font-bold">
                            <img src={mainlogo} alt="AI Codes Logo" className="h-8 w-8" />
                            <span>AI Codes</span>
                        </div>
                            ...
                            <ul className="mt-8 space-y-4 text-sm">
                                <li>
                                    ...
                                    >
                                        ...
                                        <span className="flex-1 text-gray-700">rishabh@gmail.com</span>
                                    </a>
                                </li>
